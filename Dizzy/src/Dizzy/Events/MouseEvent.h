...
namespace Dizzy
{
    class DIZZY_API MouseMovedEvent : public Event
    {
    public:
    ...
    class DIZZY_API MouseScrolledEvent : public Event
    {
    public:
    ...
    class DIZZY_API MouseButtonEvent : public Event
    {
    public:
    ...
    class DIZZY_API MouseButtonPressedEvent : public MouseButtonEvent
    {
    public:
    ...
    class DIZZY_API MouseButtonReleasedEvent : public MouseButtonEvent
    {
    public:
